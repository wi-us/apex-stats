...
CREATE TABLE IF NOT EXISTS team_tracks (
  ...
  map_x NUMERIC(10, 3),
  map_y NUMERIC(10, 3),
  source_frame_x NUMERIC(10, 3),
  source_frame_y NUMERIC(10, 3),
  map_space_valid BOOLEAN,
  backup_frame_space BOOLEAN,
  transform_state TEXT,
  transform_residual NUMERIC(10, 3),
  bg_confidence NUMERIC(6, 3),
  eliminated BOOLEAN,
...
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS map_x NUMERIC(10, 3);
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS map_y NUMERIC(10, 3);
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS source_frame_x NUMERIC(10, 3);
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS source_frame_y NUMERIC(10, 3);
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS map_space_valid BOOLEAN;
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS backup_frame_space BOOLEAN;
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS transform_state TEXT;
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS transform_residual NUMERIC(10, 3);
ALTER TABLE team_tracks ADD COLUMN IF NOT EXISTS bg_confidence NUMERIC(6, 3);
