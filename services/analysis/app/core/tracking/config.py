...
# Repo root: .../services/analysis/app/core/tracking/config.py → parents[5]
_BASE = Path(__file__).resolve()
BASE_DIR = str(_BASE.parents[5])
VIDEO_PATH = os.path.join(BASE_DIR, "ffmpeg_downloader", "my_match.mp4")
MAP_PATH = os.path.join(BASE_DIR, "assets", "maps", "mp_storm_point.png")
